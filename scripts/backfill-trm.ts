 ...
 *
 * Or directly:
 *   npx ts-node scripts/backfill-trm.ts
 */
...
async function parseTRMCSV(filePath: string): Promise<TRMRecord[]> {
  ...
  for (const line of dataLines) {
    ...
    // Calculate change
    let change: 'up' | 'down' | 'equal' = 'equal';
